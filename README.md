...
详细的分析过程、图表和业务建议请参阅：
[共享单车用户行为分析及营销计划 - Notion](https://www.notion.so/yuel/3207761aa52a80bb9ccdf325b4885960)
...
#### 数据时间跨度:
2024 年 12 月 1 日 至 2025 年 11 月 30 日

## 5. 工程结构 (Folder Structure) 
```
bike_share_analysis/
├── data/                                                   # 禁止推送到云端的目录
...
**2. R：** <br>
本项目的数据分析与可视化部分基于 R 版本 2026.01.1+403 请在 R 控制台中运行以下脚本安装所需的软件包：
...
## 7. 数据处理流程 (Pipeline)
Step 1: BigQuery 清洗（排除无效行程、计算时长）<br>
Step 2: 地理空间网格化 (Geohashing)<br>
Step 3: 探索性数据分析 (EDA)<br>
